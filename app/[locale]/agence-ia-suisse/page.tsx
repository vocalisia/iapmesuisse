...
const T = {
  fr: {
    ...
    internal_links: [
      ...
      { href: '/blog/agence-ia-pme-suisse-comparatif', label: 'Agence IA pour PME suisse : guide de sélection complet' },
  ...
  de: {
    ...
    internal_links: [
      ...
      { href: '/blog/agence-ia-pme-suisse-comparatif', label: 'KI-Agentur für Schweizer KMU: vollständiger Auswahlratgeber' },
  ...
  en: {
    ...
    internal_links: [
      ...
      { href: '/blog/agence-ia-pme-suisse-comparatif', label: 'AI agency for Swiss SMEs: complete selection guide' },
  ...
  it: {
    ...
    internal_links: [
      ...
      { href: '/blog/agence-ia-pme-suisse-comparatif', label: 'Agenzia IA per PMI svizzera: guida di selezione completa' },
