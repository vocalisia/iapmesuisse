...
const T = {
  fr: {
    ...
    internal_links_title: 'Aller plus loin',
    internal_links: [
      { href: '/consulting', label: 'Conseil IA pour PME — nos offres d\'accompagnement' },
      { href: '/services', label: 'Services IA pour PME suisses' },
      { href: '/blog/roi-intelligence-artificielle-pme-suisse', label: 'Calculer le ROI de votre projet IA' },
      { href: '/blog/ia-pme-valais-sion', label: 'IA pour PME en Valais et à Sion' },
      { href: '/formation-ia-pme', label: 'Formation IA pour dirigeants de PME' },
    ],
  },
};
