...
const translations: Record<string, {
  ...
  fr: {
    ...
    questions: [
      ...
      {
        question: "Quel niveau d'adoption IA visez-vous ?",
        answers: [
          { letter: 'A', text: 'Découverte' },
          { letter: 'B', text: 'Usage régulier' },
          { letter: 'C', text: 'Équipe' },
          { letter: 'D', text: 'Organisation avancée' },
        ],
      },
    ],
    results: {
  ...
  de: {
    ...
    questions: [
      ...
      {
        question: 'Welches KI-Einsatzniveau streben Sie an?',
        answers: [
          { letter: 'A', text: 'Découverte' },
          { letter: 'B', text: 'Usage régulier' },
          { letter: 'C', text: 'Équipe' },
  ...
  en: {
    ...
    questions: [
      ...
      {
        question: 'What level of AI adoption are you aiming for?',
        answers: [
          { letter: 'A', text: 'Découverte' },
          { letter: 'B', text: 'Usage régulier' },
          { letter: 'C', text: 'Équipe' },
  ...
  it: {
    ...
    questions: [
      ...
      {
        question: 'Quale livello di adozione IA volete raggiungere?',
        answers: [
          { letter: 'A', text: 'Découverte' },
          { letter: 'B', text: 'Usage régulier' },
          { letter: 'C', text: 'Équipe' },
