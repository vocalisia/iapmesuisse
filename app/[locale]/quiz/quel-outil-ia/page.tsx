...
const translations: Record<string, {
  ...
  fr: {
    ...
    pageSubtitle: 'Répondez à 8 questions pour découvrir l\'outil d\'intelligence artificielle qui correspond le mieux à votre profil professionnel.',
    startButton: 'Commencer le quiz',
    questionOf: 'Question {current} sur {total}',
    nextQuestion: 'Question suivante',
    resultTitle: 'Votre outil IA idéal :',
    yourTool: 'Vous êtes fait pour',
    ...
    ctaText: 'Découvrez tous les outils IA recommandés pour les PME suisses',
    ...
    questions: [
      {
        question: 'Quelle est votre priorité au travail ?',
        answers: [
          { letter: 'A', text: 'Créativité' },
          { letter: 'B', text: 'Efficacité' },
      ...
      },
      {
        ...
        answers: [
          ...
          { letter: 'B', text: 'En équipe, rapidement' },
          { letter: 'C', text: 'Avec des clients' },
          { letter: 'D', text: 'Avec des données' },
        ],
      },
      {
        question: 'Quel type de contenu créez-vous le plus ?',
        answers: [
          { letter: 'A', text: 'Textes / articles' },
          { letter: 'B', text: 'Présentations / rapports' },
          { letter: 'C', text: 'Emails / messages' },
          { letter: 'D', text: 'Tableaux / analyses' },
        ],
      },
      {
        question: 'Votre plus grand défi quotidien ?',
        answers: [
          { letter: 'A', text: 'Trouver l\'inspiration' },
          { letter: 'B', text: 'Gagner du temps' },
          { letter: 'C', text: 'Gérer les langues' },
          { letter: 'D', text: 'Prendre des décisions' },
        ],
      },
      {
        question: 'Quel super-pouvoir voudriez-vous ?',
        answers: [
          { letter: 'A', text: 'Écrire 10x plus vite' },
          { letter: 'B', text: 'Automatiser tout' },
          { letter: 'C', text: 'Parler toutes les langues' },
          { letter: 'D', text: 'Prédire le futur' },
        ],
      },
      {
      ...
      {
        question: 'Votre rapport à la technologie ?',
        answers: [
          { letter: 'A', text: 'J\'adore tester les nouveautés' },
          { letter: 'B', text: 'Je veux que ça marche, c\'est tout' },
          { letter: 'C', text: 'Je suis pragmatique' },
          { letter: 'D', text: 'Je suis data-driven' },
        ],
      },
      {
        question: 'Votre budget IA mensuel idéal ?',
        answers: [
          { letter: 'A', text: 'D?couverte autonome' },
          { letter: 'B', text: 'Accompagnement l?ger' },
          { letter: 'C', text: 'Accompagnement structur?' },
          { letter: 'D', text: 'Accompagnement avanc?' },
        ],
      },
    ],
    results: {
      A: {
        ...
        description: 'Vous êtes un créatif ! ChatGPT est votre allié idéal pour rédiger, brainstormer et créer du contenu.',
        tips: [
          'Utilisez ChatGPT pour générer des brouillons d\'articles et de posts LinkedIn',
          'Créez des templates de prompts pour vos tâches répétitives',
      ...
      B: {
        ...
        description: 'Vous êtes un optimiseur ! Les outils d\'automatisation comme Zapier ou Make vont révolutionner votre quotidien.',
        tips: [
          'Commencez par automatiser vos tâches email les plus répétitives',
          'Connectez votre CRM à vos outils de communication',
          'Créez des workflows qui se déclenchent automatiquement',
        ],
      },
      C: {
        tool: 'DeepL',
        ...
        description: 'Vous êtes un communicateur ! DeepL et les outils de traduction IA sont faits pour vous, surtout en Suisse multilingue.',
        tips: [
          'Utilisez DeepL Pro pour traduire vos documents professionnels',
          'Intégrez DeepL à votre navigateur pour traduire en temps réel',
          'Combinez DeepL avec un relecteur pour un résultat parfait',
        ],
      },
      D: {
        tool: 'Claude',
        ...
        description: 'Vous êtes un analyste ! Claude d\'Anthropic excelle dans l\'analyse approfondie et le raisonnement.',
        tips: [
          'Utilisez Claude pour analyser des documents longs et complexes',
          'Demandez-lui de structurer vos données en tableaux clairs',
          'Exploitez sa capacité de raisonnement pour vos décisions stratégiques',
        ],
      },
    },
  },
  de: {
    ...
    questions: [
      ...
      {
        question: 'Ihr ideales KI-Begleitungsniveau?',
        answers: [
          { letter: 'A', text: 'D?couverte autonome' },
          { letter: 'B', text: 'Accompagnement l?ger' },
          { letter: 'C', text: 'Accompagnement structur?' },
  ...
  en: {
    ...
    questions: [
      ...
      {
        question: 'Your ideal AI support level?',
        answers: [
          { letter: 'A', text: 'D?couverte autonome' },
          { letter: 'B', text: 'Accompagnement l?ger' },
          { letter: 'C', text: 'Accompagnement structur?' },
  ...
  it: {
    ...
    questions: [
      ...
      {
        question: 'Il vostro livello ideale di accompagnamento IA?',
        answers: [
          { letter: 'A', text: 'D?couverte autonome' },
          { letter: 'B', text: 'Accompagnement l?ger' },
          { letter: 'C', text: 'Accompagnement structur?' },
