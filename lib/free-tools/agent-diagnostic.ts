...
export function callbackPayload(diagnosis: Diagnosis, callback: Callback, sourcePath: string) {
  ...
  return { subject: 'IAPME Suisse — Demande de rappel pour un agent IA sur mesure', from_site: 'iapmesuisse.ch', name: c.name, email: c.email, company: d.company, phone: c.phone, website: d.website || 'Aucun site renseigné', botcheck: false,
