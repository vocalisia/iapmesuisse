---
title: "L'IA en Suisse : état des lieux 2025"
date: "2025-02-20"
...
Un an après la rédaction initiale de ce panorama, plusieurs évolutions méritent d'être intégrées. Selon les données consolidées de digitalswitzerland et de l'[Office fédéral de la statistique](https://www.bfs.admin.ch), l'adoption de l'IA par les PME suisses a continué à progresser :
...
Du côté des grandes entreprises, le baromètre [Swisscom Digital](https://www.swisscom.ch) indique que 92 % des sociétés cotées au SMI ont déployé au moins une solution d'IA générative en production en 2026. Le Crédit Suisse intégré à UBS, Nestlé, Roche, Novartis et Zurich Insurance figurent parmi les déploiements les plus matures.
...
- **Été 2025** : le [PFPDT](https://www.edoeb.admin.ch) a publié des lignes directrices spécifiques sur les LLM, imposant aux PME une analyse d'impact relative à la protection des données (AIPD) pour tout déploiement traitant des données personnelles à grande échelle.
...
Pour franchir ces obstacles, un [accompagnement IA](/fr/consulting) structuré combinant audit technique, cadrage juridique et conduite du changement permet de réduire le risque et d'accélérer le retour sur investissement. Nos [programmes de formation](/fr/formation-ia-pme) ciblent en priorité les dirigeants et les middle managers, qui sont les vrais leviers d'adoption.

## Stratégie nationale et initiatives publiques

Au-delà du cadre légal, la Confédération multiplie les initiatives concrètes :

- **Innosuisse** finance désormais des projets IA dédiés aux PME, avec des taux de subvention pouvant atteindre 50 % du coût d'un projet d'innovation. Voir les modalités sur [seco.admin.ch](https://www.seco.admin.ch) et le portail Innosuisse.
...
- **L'OFCOM** ([BAKOM](https://www.bakom.admin.ch)) coordonne la stratégie numérique nationale et publie régulièrement des baromètres sur la digitalisation des PME.
