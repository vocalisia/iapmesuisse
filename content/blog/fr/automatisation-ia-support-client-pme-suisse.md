---
title: 'Automatisation IA du support client PME suisse'
...
slug: automatisation-ia-support-client-pme-suisse
category: Automatisation IA
pillar: intelligence-artificielle-suisse-pme-guide-operationnel
image: /images/blog/iapmesuisse-photos-20260828/automatisation-ia-support-client-pme-suisse-photo.png
---
...
Ce guide traite le workflow de support. Il se distingue du guide sur l’[agent IA de service client](/fr/blog/agent-ia-service-client-pme-suisse), qui détaille la base de connaissances, le multilinguisme et la qualité de réponse. Ici, la question est différente : comment faire circuler une demande entre les canaux, les outils et les responsables sans perdre d’information ni automatiser une décision sensible.
...
Un message de support peut contenir des informations personnelles, un historique de relation, une pièce jointe, un numéro de compte ou une demande liée à un incident. Le [PFPDT rappelle que le droit suisse de la protection des données s’applique à l’IA](https://www.edoeb.admin.ch/fr/ia-et-protection-des-donnees). Avant de connecter un outil, la PME doit donc définir la finalité, les données nécessaires, les accès, les fournisseurs impliqués et la manière de traiter les erreurs.

La page du PFPDT sur le [devoir d’informer](https://www.edoeb.admin.ch/fr/devoir-dinformer) aide à examiner les éléments à communiquer lorsque les conditions l’exigent. Le workflow ne doit pas utiliser plus de données que nécessaire pour préparer la tâche. Dans un pilote, il est souvent possible d’exclure les pièces jointes, de limiter les champs transmis, de travailler sur des cas anonymisés et de restreindre l’accès à quelques utilisateurs.

Les accès doivent correspondre aux rôles. Une personne qui supervise une file de support n’a pas forcément besoin de voir l’ensemble du CRM. Un intégrateur n’a pas besoin d’un accès permanent à toutes les conversations. Documentez les comptes de service, les connecteurs, les journaux et la procédure qui permet de révoquer un accès. Le [NCSC suisse](https://www.ncsc.admin.ch/ncsc/fr/home.html) propose des ressources de prévention utiles ; leur traduction pratique consiste ici à savoir qui peut modifier le flux, consulter les journaux et arrêter le système.
