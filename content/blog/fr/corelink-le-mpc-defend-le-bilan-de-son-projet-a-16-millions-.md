---
title: "Ce que les PME suisses doivent retenir : Core.Link: le MPC défend le bilan de son projet à 16 m"
date: "2026-06-11"
excerpt: "Le Ministère public de la Confédération (MPC) a renoncé à développer en interne le successeur de JURIS. Selon l’Autorité de surveillance du Ministère publi"
slug: "corelink-le-mpc-defend-le-bilan-de-son-projet-a-16-millions-"
author: "IAPME Suisse"
...
L'actualité publiée par ICTjournal met en lumière un sujet que les PME suisses ne peuvent plus traiter comme une simple veille technologique : Core.Link: le MPC défend le bilan de son projet à 16 millions (update). Pour une entreprise romande, alémanique ou tessinoise, l'enjeu n'est pas de suivre chaque nouveauté, mais de comprendre ce qui peut améliorer l'efficacité, la conformité et la compétitivité.

Le Ministère public de la Confédération (MPC) a renoncé à développer en interne le successeur de JURIS. Selon l’Autorité de surveillance du Ministère public de la Confédération, 16,4 millions de francs ont été dépensés dans le cadre du projet Core.Link. Le MPC défend toutefois le bilan du projet, estimant que ses résultats ne se limitent pas à l’abandon du remplacement de JURIS.
