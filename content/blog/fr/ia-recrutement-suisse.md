...
image: "/images/blog/iapme-autocontrol-20260620/fr-ia-recrutement-suisse.webp"
---
...
| Outil | Fonctionnalités IA | Prix (CHF/mois) | Adapté CH |
|---|---|---|---|
| Factorial | Tri CV, analytics RH, portail candidat | Dès 5.75/collaborateur | Oui |
| Personio | Matching IA, workflows automatisés | Dès 8/collaborateur | Oui |
| SmartRecruiters | Scoring IA, sourcing intelligent | Sur devis (~500+) | Partiel |
| Jobcloud (jobs.ch) | Matching IA natif marché suisse | Sur devis | Excellent |

### Outils d'évaluation prédictive

| Outil | Spécialité | Prix (CHF) | Conformité |
|---|---|---|---|
| AssessFirst | Prédiction performance/rétention | Dès 200/mois | RGPD/nLPD |
| Pymetrics | Évaluation cognitive par jeux | Sur devis | RGPD |
| HireVue | Entretiens vidéo + analyse | Sur devis | Variable |
| TestGorilla | Tests de compétences IA | Dès 80/mois | RGPD |

### Outils complémentaires

| Outil | Usage | Prix (CHF) |
|---|---|---|
| Textio | Optimisation des offres d'emploi | Dès 450/mois |
| Paradox (Olivia) | Chatbot recrutement | Sur devis |
| Phenom | Plateforme talent expérience | Sur devis |
...
| Poste | PME 10-30 pers. | PME 30-100 pers. |
|---|---|---|
| ATS avec IA | 200 – 500 CHF/mois | 500 – 1'500 CHF/mois |
| Outil d'évaluation | 100 – 300 CHF/mois | 300 – 800 CHF/mois |
| Setup et intégration | 3'000 – 8'000 CHF | 8'000 – 20'000 CHF |
| Formation | 1'000 – 2'500 CHF | 2'500 – 5'000 CHF |
| **Budget année 1** | **7'600 – 20'100** | **17'600 – 47'600** |
...
- [SECO — Marché du travail et emploi en Suisse](https://www.seco.admin.ch/seco/fr/home.html)
