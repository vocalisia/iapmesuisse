...
Une bonne agence commence par auditer l'existant : indexation, maillage, contenu duplique, intention, schema, logs et Search Console. Elle identifie ensuite les pages piliers et les opportunites d'articles satellites. Elle doit aussi expliquer comment elle evite le contenu IA generique.
...
### Une agence SEO doit-elle utiliser l'IA ?

Oui, mais comme outil d'analyse et d'acceleration, pas comme usine a contenu non relu.

### Quel livrable demander ?

Un plan de cluster, une liste d'ancres internes, des briefs editoriaux et une methode de suivi Search Console.

### Comment mesurer la qualite ?

Regardez les pages qui progressent, les impressions, les clics, les citations et la coherence du maillage.
