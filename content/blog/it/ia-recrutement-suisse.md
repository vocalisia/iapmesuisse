---
title: "IA per il reclutamento in Svizzera"
date: "2026-03-26"
excerpt: "Come l'intelligenza artificiale sta rivoluzionando il reclutamento nelle PMI svizzere: selezione dei CV, colloqui video, riduzione dei bias, strumenti e conformità nLPD."
...
- Costo medio per reclutamento tra 8'000 e 15'000 CHF
...
- Onboarding assistito da chatbot

## Gli strumenti IA per il reclutamento adatti al mercato svizzero

### Strumenti di gestione del reclutamento (ATS) con IA

| Strumento | Funzionalità IA | Prezzo (CHF/mese) | Adatto CH |
|---|---|---|---|
| Factorial | Selezione CV, analytics HR, portale candidati | Da 5.75/collaboratore | Sì |
| Personio | Matching IA, workflow automatizzati | Da 8/collaboratore | Sì |
| SmartRecruiters | Scoring IA, sourcing intelligente | Su richiesta (~500+) | Parziale |
| Jobcloud (jobs.ch) | Matching IA nativo mercato svizzero | Su richiesta | Eccellente |

### Strumenti di valutazione predittiva

| Strumento | Specialità | Prezzo (CHF) | Conformità |
|---|---|---|---|
| AssessFirst | Previsione performance/retention | Da 200/mese | RGPD/nLPD |
| Pymetrics | Valutazione cognitiva tramite giochi | Su richiesta | RGPD |
| HireVue | Colloqui video + analisi | Su richiesta | Variabile |
| TestGorilla | Test di competenze IA | Da 80/mese | RGPD |

### Strumenti complementari

| Strumento | Utilizzo | Prezzo (CHF) |
|---|---|---|
| Textio | Ottimizzazione delle offerte di lavoro | Da 450/mese |
| Paradox (Olivia) | Chatbot per il reclutamento | Su richiesta |
| Phenom | Piattaforma esperienza talenti | Su richiesta |

## Conformità legale: le regole in Svizzera

### La nLPD e il reclutamento IA

L'uso dell'IA nel reclutamento è un ambito particolarmente sensibile rispetto alla [nLPD](/fr/blog/nlpd-ia-obligations-pme). Diverse obbligazioni si applicano:

**Informazione ai candidati**: è necessario informare i candidati che la loro candidatura sarà analizzata da uno strumento IA. Questa informazione deve essere inclusa nell'offerta di lavoro o comunicata al momento della candidatura.

**Decisione finale umana**: conformemente all'articolo 21 della nLPD, il candidato può richiedere che una decisione automatizzata (rifiuto della candidatura) sia riesaminata da un essere umano. Il processo deve prevedere questo meccanismo.
...
1. **Documentate** il vostro processo di reclutamento IA dall'inizio alla fine
2. **Informate** sistematicamente i candidati sull'uso dell'IA
3. **Mantenete** un intervento umano in ogni fase decisionale
4. **Auditate** regolarmente i risultati dell'IA per rilevare bias
5. **Conservate** i dati dei candidati secondo i termini legali (eliminare dopo massimo 6 mesi se non selezionati, salvo consenso esplicito)
...
- Implementazione su 2-3 posizioni da coprire
...
**Investimento**:
- Setup iniziale: 5'000 CHF
- Abbonamenti mensili: 850 CHF
- Formazione HR: 1'500 CHF
...
- **Decidere da sola**: l'IA raccomanda, l'umano decide
...
| Voce | PMI 10-30 pers. | PMI 30-100 pers. |
|---|---|---|
| ATS con IA | 200 – 500 CHF/mese | 500 – 1'500 CHF/mese |
| Strumento di valutazione | 100 – 300 CHF/mese | 300 – 800 CHF/mese |
| Setup e integrazione | 3'000 – 8'000 CHF | 8'000 – 20'000 CHF |
| Formazione | 1'000 – 2'500 CHF | 2'500 – 5'000 CHF |
| **Budget anno 1** | **7'600 – 20'100** | **17'600 – 47'600** |
...
- [nLPD e IA: obblighi delle PMI svizzere](/fr/blog/nlpd-ia-obligations-pme)
- [Gli strumenti IA testati e approvati per PMI svizzere](/fr/blog/outils-ia-pme-suisses)

### Risorsa esterna

- [SECO — Mercato del lavoro e occupazione in Svizzera](https://www.seco.admin.ch/seco/it/home.html)