...
**AI claims automation in Switzerland** helps brokers and insurers receive loss notifications, classify documents, detect missing information, route cases and support human decisions faster. For independent brokers, the opportunity is practical: reduce manual handling, improve client updates and keep regulated decisions explainable.

> For the broader SME context, see the [AI automation guide for Swiss SMEs](/en/automatisation-ia-pme-suisse).
...
AI can analyse risk profiles from available data and prepare a structured underwriting summary. For brokers, this means more consistent file preparation, fewer missing fields and faster communication with insurers.
...
- [FINMA guidance on AI governance and risk management](https://www.finma.ch/en/news/2024/12/20241218-mm-finma-am-08-24/).
- [Federal Act on Data Protection on Fedlex](https://www.fedlex.admin.ch/eli/cc/2022/491/en).
- [New Federal Act on Data Protection for SMEs on KMU.admin.ch](https://www.kmu.admin.ch/kmu/en/home/facts-and-trends/digitization/data-protection/new-federal-act-on-data-protection-nfadp.html).

## Tools used by Swiss brokers

| Tool type | Typical role | Swiss governance note |
|---|---|---|
| Brokerage CRM | Client, policy and case record | Review access rights and retention |
| Document AI | Extract claim facts and missing fields | Keep confidence thresholds visible |
| Workflow automation | Route claims and reminders | Use human checkpoints |
| Voice or chat assistant | First response and status updates | Escalate regulated advice |
| Identity verification | KYC or client validation | Confirm provider and jurisdiction |
...
1. Map the current claims workflow from notification to closure.
2. Identify document types, data categories and regulated decision points.
3. Start with intake classification and missing-document detection.
4. Add client-message drafting with mandatory human approval.
5. Define escalation rules for sensitive, disputed or low-confidence cases.
6. Test with historical anonymised files.
7. Train brokers on AI limits, data rules and review responsibilities.
...
- [DPO and Swiss FADP in the age of AI](/en/blog/dpo-nlpd-ia-obligations-pratiques-pme-suisse)
- [Autonomous AI agents for Swiss SMEs](/en/blog/agents-ia-autonomes-pme-suisse-2026)
- [AI voice assistant for SMEs](/en/blog/assistant-vocal-ia-pme-guide-complet)
